...
export class Footer extends React.Component {
    ...
    handleSubmit = (e) => {
        ...
        if (this.validateForm(this.state.errors)) {
            fetch("https://my-spa-adb78-default-rtdb.firebaseio.com/form.json", {
                method: 'POST',
                headers: {
            ...
            <footer className="footer">
                ...
                <div className="footer-form">
                    <form className="form" onSubmit={this.handleSubmit}>
                        <div className="form__element form__element_name">
                        ...
                        <div className="form__element form__element_email">
                        ...
                        <div className="form__element form__element_subject">
                        ...
                        <div className="form__element form__element_textarea">
